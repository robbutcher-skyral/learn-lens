...
export function useDashboardLayer() {
  ...
  return useMemo(
    () => ({
      ...
      color: (mainLayer?.metadata as DashboardLayerMetadata | undefined)?.color,
    }),
...
export function useDashboardHover() {
